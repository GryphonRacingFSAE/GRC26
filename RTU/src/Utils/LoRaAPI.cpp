...
// Match RRU/Embedded: 50 Hz core telemetry, with field validation at the 1 km target.
...
{
    static const uint32_t rfswitchDioPins[] = {RADIOLIB_LR11X0_DIO5, RADIOLIB_LR11X0_DIO6, RADIOLIB_LR11X0_DIO7,
