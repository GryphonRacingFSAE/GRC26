...
// Version 1 layouts are retained ONLY for the existing receiver implementation.
// Sender acquisition/serialization uses the explicitly versioned V2 members below.
...
static_assert(sizeof(TelemetryPacket) == 59, "Queue item must contain the complete V2 powertrain packet");
