...
void ui_speed_init() {
    ...
    lv_obj_align(speed_label, LV_ALIGN_CENTER, 0, marginY);  
    ...
    lv_obj_align_to(speed_ui, speed_label, LV_ALIGN_OUT_BOTTOM_MID, 0, CAPTION_GAP);
}
...
void ui_speed_update(const EcuData_t* data) {
    ...
    char buf[8];
    snprintf(buf, sizeof(buf), "%d", (int)round(data->speed));
